...
function C3forMe() {
  return (
    ...
    <div className="flex flex-col justify-center w-[90%] md:w-[70%] lg:w-[60%] mx-auto">
      ...
      Conversation Cue Cards (C3 For Me) is a platform designed to foster meaningful conversations for students with disabilities and neurodiverse individuals, enabling them to articulate their aspirations and strengths.
      <br/><br/>
